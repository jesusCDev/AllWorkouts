...
public class SitUps extends Workout{
    ...
    private final static double FIRST_VALUE_DIFFICULTY = 0.5; // Punching
    private final static double SECOND_VALUE_DIFFICULTY = 0.8; // Normal
    private final static double THIRD_VALUE_DIFFICULTY = 0.4; // To Knee
    private final static double FORTH_VALUE_DIFFICULTY = 0.6; // Bicycle
    private final static double FIFTH_VALUE_DIFFICULTY = 0.3; // Crunch

    private final static String FIRST_WORKOUT_NAME = "Punching";
    private final static String SECOND_WORKOUT_NAME = "Normal";
    private final static String THIRD_WORKOUT_NAME = "To Knee";
    private final static String FORTH_WORKOUT_NAME = "Bicycle";
    private final static String FIFTH_WORKOUT_NAME = "Crunch";
    ...
    public SitUps(double type, int max){
        if(type == 0){
