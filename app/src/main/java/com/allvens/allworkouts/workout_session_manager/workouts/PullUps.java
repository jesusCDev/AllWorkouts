...
public class PullUps extends Workout{
    ...
    private final static double BACK_ARM_VALUE_DIFFICULTY = 0.6; // Back Arm
    ...
    private final static String[] WORKOUT_DESCRIPTIONS_MIX = {WIDE_ARM_DES, PUll_UP_DES, SIDE_ARM_DES, CHIN_UP, ONE_ARM_DES};

    private final static double[] DIFFICULTY_VALUES = {WIDE_ARM_VALUE_DIFFICULTY,
            PULL_UP_VALUE_DIFFICULTY, SIDE_ARM_VALUE_DIFFICULTY, BACK_ARM_VALUE_DIFFICULTY,
            ONE_ARM_VALUE_DIFFICULTY};

    private final static String[] WORKOUT_NAMES = {WIDE_ARM_WORKOUT_NAME,
            PULL_UP_WORKOUT_NAME, SIDE_ARM_WORKOUT_NAME, CHIN_UP_WORKOUT_NAME,
